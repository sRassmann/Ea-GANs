...
#SBATCH --gres=gpu:1
#SBATCH --output=/home/rassmanns/diffusion/Ea-GANs/output/logs/ea_nogan.out

module load singularity
cd $HOME/diffusion/Ea-GANs

# singularity container build based on flairsyn/Dockerfile
NAME=ea_gan_brats_no_gan
...
singularity exec --nv -B /groups/ag-reuter/projects/flair_synthesis \
 ...
 --rise_sobelLoss --batchSize 6 --config config_brats.yml --lambda_A 300 --niter 150 \
 --lambda_gan 0
